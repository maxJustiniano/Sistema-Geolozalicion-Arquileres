...
<body>
    <div class="error-container">
        ...
        <div class="error-details">
            <p>Es posible que necesites iniciar sesión o que tu cuenta no tenga los privilegios necesarios para ver este contenido.</p>
    ...
    <script>
        setTimeout(function() {
            window.location.href = 'index.html'; //redirecciona hacia:
        }, 5000);
